...
class CrossOver : public DataNode<CrossOver<InputType1, InputType2>, std::vector<bool>> {
  std::shared_ptr<OutputNode<std::vector<InputType1>>> _input_data1;
  std::shared_ptr<OutputNode<std::vector<InputType2>>> _input_data2;
...
public:
  CrossOver(std::shared_ptr<OutputNode<std::vector<InputType1>>> node1,
            std::shared_ptr<OutputNode<std::vector<InputType2>>> node2)
      : DataNode<CrossOver<InputType1, InputType2>, std::vector<bool>>(node1, node2) {
